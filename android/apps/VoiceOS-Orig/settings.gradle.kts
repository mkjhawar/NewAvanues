...
// ALC - AI Language Core (Kotlin Multiplatform LLM Engine)
include(":Modules:ALC")  // KMP LLM inference engine (Android TVM, iOS CoreML, Desktop ONNX)
...
// ALC - AI Language Core (KMP LLM Engine)
project(":Modules:ALC").projectDir = file("../../../Modules/ALC")
