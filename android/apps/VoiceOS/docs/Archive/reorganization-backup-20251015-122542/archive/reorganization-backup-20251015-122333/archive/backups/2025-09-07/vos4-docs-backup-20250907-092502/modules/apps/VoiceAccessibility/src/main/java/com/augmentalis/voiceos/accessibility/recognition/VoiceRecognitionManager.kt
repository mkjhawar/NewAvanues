 ...
 * Created: 2025-08-28
 * 
 * Example integration class showing how to use VoiceRecognitionBinder
 * with ActionCoordinator in VoiceAccessibilityService.
 */
package com.augmentalis.voiceos.accessibility.recognition
