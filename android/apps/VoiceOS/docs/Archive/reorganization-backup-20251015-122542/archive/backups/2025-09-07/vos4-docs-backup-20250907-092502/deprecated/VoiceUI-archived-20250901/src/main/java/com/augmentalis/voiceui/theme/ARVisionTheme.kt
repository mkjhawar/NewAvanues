/**
 * ARVisionTheme.kt  
 * Path: apps/VoiceUI/src/main/java/com/augmentalis/voiceui/theme/ARVisionTheme.kt
 * 
 * Created: 2025-01-23
...
object ARVisionColors {
    ...
    val VibrantTeal = Color(0xFF5AC8FA)
    val VibrantIndigo = Color(0xFF5856D6)
    ...
    val AdaptiveQuaternaryText = Color(0x66FFFFFF)
    ...
    val SystemNeutral = Color(0xFF8E8E93)
}
...
object ARVisionTypography {
    ...
    val Caption = Typography().labelMedium.copy(
        fontWeight = androidx.compose.ui.text.font.FontWeight.Medium,
...
fun ARVisionTheme(
    ...
    val colorScheme = if (darkTheme) {
        darkColorScheme(
            primary = ARVisionColors.VibrantBlue,
            secondary = ARVisionColors.VibrantTeal,
            tertiary = ARVisionColors.VibrantPurple,
            background = Color.Black.copy(alpha = 0.95f),
            surface = ARVisionColors.GlassPrimary,
            onPrimary = Color.White,
            onSecondary = Color.White,
            onBackground = ARVisionColors.AdaptiveText,
            onSurface = ARVisionColors.AdaptiveText
        )
    } else {
        lightColorScheme(
            primary = ARVisionColors.VibrantBlue,
