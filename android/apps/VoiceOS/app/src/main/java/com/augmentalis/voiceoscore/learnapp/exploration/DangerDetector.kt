 ...
 * Path: apps/VoiceOSCore/src/main/java/com/augmentalis/voiceoscore/learnapp/exploration/DangerDetector.kt
 *
 * Author: Manoj Jhawar (refactored by Claude)
 * Created: 2025-12-05
 * Refactored: 2026-01-15 (SOLID extraction from ExplorationEngine.kt)
 *
 * Single Responsibility: Detects dangerous and critical dangerous elements
 * that should not be clicked during automated exploration.
 *
