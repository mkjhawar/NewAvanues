...
class VoiceOSAccessibilityService : AccessibilityService() {
    ...
    private val appCategoryProvider: IAppCategoryProvider by lazy {
        VoiceOSApplication.getInstance(applicationContext).appCategoryProvider
    }
    ...
    override fun onServiceConnected() {
        ...
        try {
            VoiceOSApplication.getInstance(applicationContext)
