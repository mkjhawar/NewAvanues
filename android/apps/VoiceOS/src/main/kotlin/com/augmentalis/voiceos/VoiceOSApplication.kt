...
import com.augmentalis.voiceos.service.AndroidAppCategoryProvider
import com.augmentalis.voiceos.service.AndroidAssetReader
import com.augmentalis.voiceos.service.SQLDelightAppCategoryOverrideRepository
import com.augmentalis.voiceos.service.SQLDelightAppPatternGroupRepository
...
class VoiceOSApplication : Application() {
    ...
    private fun initializeAppCategorySystem() {
        ...
        applicationScope.launch {
            try {
                val assetReader = AndroidAssetReader(this@VoiceOSApplication)
    ...
    companion object {
         ...
         */
        fun getInstance(context: android.content.Context): VoiceOSApplication {
            return context.applicationContext as VoiceOSApplication
        }
    }
}
