...
/**
 * AvanueAVIDIntegration - Seamless AVID tracking for all VoiceUI components
 *
 * Features:
...
fun rememberMagicAVID(type: String, name: String? = null): String {
    return AvanueAVIDIntegration.rememberComponentUUID(type, name = name)
}

@Composable
fun rememberScreenAVID(name: String): String {
    return AvanueAVIDIntegration.rememberScreenUUID(name)
}
