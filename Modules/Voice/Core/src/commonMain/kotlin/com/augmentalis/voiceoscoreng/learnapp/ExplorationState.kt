...
data class ExplorationSession(
    ...
    val startTime: Long = com.augmentalis.voiceoscoreng.features.currentTimeMillis(),
    ...
    companion object {
         ...
         */
        fun currentTimeMillis(): Long = com.augmentalis.voiceoscoreng.features.currentTimeMillis()
