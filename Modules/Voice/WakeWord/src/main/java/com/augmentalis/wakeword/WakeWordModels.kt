// filename: Universal/AVA/Features/WakeWord/src/main/java/com/augmentalis/ava/features/wakeword/WakeWordModels.kt
// created: 2025-11-22
// author: Manoj Jhawar
...
sealed class WakeWordEvent {
     ...
     * Detection started
     */
    object Started : WakeWordEvent()

    /**
     * Detection stopped
     */
    object Stopped : WakeWordEvent()
