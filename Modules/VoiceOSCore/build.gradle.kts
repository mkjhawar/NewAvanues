    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                ...
                // SQLDelight runtime (queries generated by :Modules:Database)
                implementation(libs.sqldelight.coroutines.extensions)

                // Unified Database - VoiceOSDatabase + generated queries
                // Moved from androidMain to commonMain for StaticCommandPersistenceImpl
        ...
        val androidMain by getting {
            dependencies {
                ...
                // Database dep inherited from commonMain (for StaticCommandPersistenceImpl KMP path)
