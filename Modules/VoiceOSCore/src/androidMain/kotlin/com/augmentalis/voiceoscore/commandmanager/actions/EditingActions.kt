...
class EditingActions(
     ...
     */
    private fun performCopy(command: Command): CommandExecutionResult {
        return try {
     ...
     */
    private fun performPaste(command: Command): CommandExecutionResult {
        return try {
     ...
     */
    private fun performCut(command: Command): CommandExecutionResult {
        return try {
     ...
     */
    private fun performSelectAll(command: Command): CommandExecutionResult {
        return try {
            val rootNode = accessibilityService?.rootInActiveWindow
            val focusedNode = findFocusedEditableNode(rootNode)
     ...
     */
    private fun performUndo(command: Command): CommandExecutionResult {
        return try {
            val rootNode = accessibilityService?.rootInActiveWindow
            val focusedNode = findFocusedEditableNode(rootNode)
     ...
     */
    private fun performRedo(command: Command): CommandExecutionResult {
        return try {
            val rootNode = accessibilityService?.rootInActiveWindow
            val focusedNode = findFocusedEditableNode(rootNode)
