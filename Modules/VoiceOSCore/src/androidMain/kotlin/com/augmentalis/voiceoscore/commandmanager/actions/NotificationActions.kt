...
object NotificationActions {
    ...
    class ReadNotificationsAction : BaseAction() {
        override suspend fun execute(
            ...
            context: Context
        ): CommandExecutionResult = withContext(Dispatchers.Main) {
    ...
    private fun getActiveNotifications(@Suppress("UNUSED_PARAMETER") context: Context): List<NotificationInfo> {
        return try {
            val listener = com.augmentalis.voiceoscore.commandmanager.notifications.VoiceOSNotificationListener.instance
            if (listener == null) {
