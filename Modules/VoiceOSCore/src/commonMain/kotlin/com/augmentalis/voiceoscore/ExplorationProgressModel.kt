...
// ExplorationState is defined in ExplorationState.kt with more comprehensive values

/**
 * Simple exploration progress state for progress tracking.
 * Maps to the comprehensive ExplorationState enum.
 */
enum class ExplorationProgressState {
    IDLE,
    RUNNING,
    PAUSED,
    COMPLETED,
...
data class ExplorationProgressModel(
    ...
    val state: ExplorationProgressState = ExplorationProgressState.IDLE,
     ...
     */
    fun isActive(): Boolean = state == ExplorationProgressState.RUNNING

    /**
     * Check if exploration is paused.
     */
    fun isPaused(): Boolean = state == ExplorationProgressState.PAUSED

    /**
     * Check if exploration is completed.
     */
    fun isCompleted(): Boolean = state == ExplorationProgressState.COMPLETED

    /**
     * Check if exploration has failed.
     */
    fun isFailed(): Boolean = state == ExplorationProgressState.FAILED
    ...
    fun getStatusMessage(): String {
        return when (state) {
            ExplorationProgressState.IDLE -> "Exploration idle"
            ExplorationProgressState.RUNNING -> "Exploring $packageName ($progressPercent%)"
            ExplorationProgressState.PAUSED -> "Paused: ${pauseReason ?: "unknown reason"}"
            ExplorationProgressState.COMPLETED -> "Completed: $screensExplored screens, $elementsDiscovered elements"
            ExplorationProgressState.FAILED -> "Failed: ${pauseReason ?: "unknown error"}"
        }
    }
    ...
    companion object {
        ...
        fun idle(): ExplorationProgressModel {
            return ExplorationProgressModel(state = ExplorationProgressState.IDLE)
        }
        ...
        fun running(
            ...
            return ExplorationProgressModel(
                ...
                state = ExplorationProgressState.RUNNING,
        ...
        fun paused(
            ...
            return ExplorationProgressModel(
                ...
                elementsDiscovered = elementsDiscovered,
                packageName = packageName,
                state = ExplorationProgressState.PAUSED,
        ...
        fun completed(
            ...
            return ExplorationProgressModel(
                ...
                elementsDiscovered = elementsDiscovered,
                packageName = packageName,
                state = ExplorationProgressState.COMPLETED,
                progressPercent = 100,
                elapsedMs = elapsedMs
            )
        }
        ...
        fun failed(
            ...
            return ExplorationProgressModel(
                ...
                elementsDiscovered = elementsDiscovered,
                packageName = packageName,
                state = ExplorationProgressState.FAILED,
