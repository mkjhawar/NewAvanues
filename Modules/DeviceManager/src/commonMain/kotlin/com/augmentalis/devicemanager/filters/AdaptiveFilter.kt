...
package com.augmentalis.devicemanager.filters

import com.augmentalis.devicemanager.math.Quaternion
import com.augmentalis.devicemanager.math.Vector3
import com.augmentalis.devicemanager.math.angularDistance
import com.augmentalis.devicemanager.math.lerp
import com.augmentalis.devicemanager.math.slerp
import kotlinx.atomicfu.locks.reentrantLock
import kotlinx.atomicfu.locks.withLock
import kotlin.math.*

/**
 * Motion data for filtering
 */
...
class AdaptiveFilter {
    ...
    private val jitterLock = reentrantLock()
    ...
    fun filterOrientation(orientation: Quaternion, timestamp: Long): Quaternion {
        ...
        val angularDist = angularDistance(previousOrientation, orientation)
        val angularVelocity = angularDist / deltaTime
