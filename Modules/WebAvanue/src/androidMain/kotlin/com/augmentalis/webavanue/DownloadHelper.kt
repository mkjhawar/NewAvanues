...
object DownloadHelper {
     ...
     * @return AndroidDownloadProgress or null if not found
     */
    fun queryProgress(context: Context, downloadId: Long): AndroidDownloadProgress? {
        val downloadManager = context.getSystemService(Context.DOWNLOAD_SERVICE) as DownloadManager
...
/**
 * Data class for Android DownloadManager progress information
 *
 * This is an Android-specific version that uses DownloadManager constants.
 * For platform-agnostic download progress, use com.augmentalis.webavanue.DownloadProgress
 * from DownloadQueue.kt which uses the DownloadStatus enum.
 */
