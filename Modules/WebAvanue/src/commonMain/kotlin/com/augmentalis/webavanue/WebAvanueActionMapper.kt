...
import com.augmentalis.webavanue.VoiceOSWebController
 ...
 * - Mapper executes appropriate browser actions via TabViewModel/VoiceOSWebController
 *
 * See: Developer Manual Chapter 46, ADR-007
 */
class WebAvanueActionMapper(
    private val tabViewModel: TabViewModel,
    private val webViewController: VoiceOSWebController
) {
    /**
