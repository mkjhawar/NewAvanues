...
import com.augmentalis.webavanue.VoiceOSWebCallback
 ...
 */
/**
 * WebViewDownloadInfo - Data class for download request information from WebView
 *
 * Contains download event data from WebView callbacks. This is simpler than
 * DownloadRequest (in DownloadQueue.kt) which is used for full download management.
 *
 * The DownloadViewModel.startDownload() converts this to a full DownloadRequest.
 */
data class WebViewDownloadInfo(
    val url: String,
    val filename: String,
    val mimeType: String?,
...
expect fun WebViewContainer(
    ...
    onDownloadStart: ((WebViewDownloadInfo) -> Unit)? = null,
