...
private fun com.augmentalis.database.avid.Avid_elements.toAvidElementDTO() = AvidElementDTO(
    avid = avid,
    name = name,
    type = type,
...
private fun com.augmentalis.database.avid.Avid_hierarchy.toAvidHierarchyDTO() = AvidHierarchyDTO(
    id = id,
    parentAvid = parent_avid,
...
private fun com.augmentalis.database.avid.Avid_analytics.toAvidAnalyticsDTO() = AvidAnalyticsDTO(
    avid = avid,
...
private fun com.augmentalis.database.avid.Avid_aliases.toAvidAliasDTO() = AvidAliasDTO(
    id = id,
    alias = alias,
    avid = avid,
