/**
 * DoNotClickList.kt - Safety filter for dangerous UI elements
 *
...
object DoNotClickList {
    ...
    fun toDncLine(element: ElementInfo, reason: DoNotClickReason): String {
        val elementId = element.uuid ?: element.stableId().take(20)
        val label = element.getDisplayName().take(30).replace(":", "_")
