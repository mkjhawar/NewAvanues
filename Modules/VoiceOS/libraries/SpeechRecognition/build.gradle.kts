...
dependencies {
    ...
    // OkHttp & Gson - For network requests & Firebase
    ...
    // Whisper Android - DEFERRED TO BACKLOG
    // Native library build removed to fix JNA dependency issue
    // TODO: Re-enable when Whisper integration is revisited
    
    // Database - Uses VoiceDataManager (migrating from Room to SQLDelight for KMP compatibility)
