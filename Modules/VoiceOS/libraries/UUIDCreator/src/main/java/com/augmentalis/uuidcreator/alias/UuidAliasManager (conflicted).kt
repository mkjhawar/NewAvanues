...
class UuidAliasManager(
     ...
     *
     * @param vuid The UUID to assign alias to
     ...
     *
     * @param vuid The UUID to look up
     ...
     *
     * @param vuid The UUID to remove aliases for
     */
     ...
     *
     * @param vuidAliasMap Map of UUID to desired alias
