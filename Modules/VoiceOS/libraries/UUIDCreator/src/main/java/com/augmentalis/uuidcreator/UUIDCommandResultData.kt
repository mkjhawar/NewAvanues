/**
 * UUIDCommandResultData.kt - UUID command execution result for IPC
 *
...
import com.augmentalis.uuidcreator.models.UUIDCommandResult
...
data class UUIDCommandResultData(
    ...
    /**
     * UUID of target element (if command targeted a specific element)
     */
