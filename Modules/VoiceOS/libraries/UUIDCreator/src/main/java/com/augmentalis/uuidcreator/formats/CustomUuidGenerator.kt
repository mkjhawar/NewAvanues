/**
 * CustomUuidGenerator.kt - Generate UUIDs with custom prefixes
 * Path: libraries/UUIDCreator/src/main/java/com/augmentalis/uuidcreator/formats/CustomUuidGenerator.kt
 *
 * Author: Manoj Jhawar
 ...
 *
 * ```kotlin
 * val generator = CustomUuidGenerator()
 *
 * // Simple prefix
