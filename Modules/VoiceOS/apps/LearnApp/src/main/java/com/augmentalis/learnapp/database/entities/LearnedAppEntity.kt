/**
 * LearnedAppEntity.kt - Data class for learned apps
 * Path: apps/LearnApp/src/main/java/com/augmentalis/learnapp/database/entities/LearnedAppEntity.kt
 *
 * Author: Manoj Jhawar
 ...
 *
 * Data class for storing learned app metadata
 */
