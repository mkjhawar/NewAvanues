...
class NegativeIndicatorAnalyzer {
    ...
    companion object {
        ...
        // Penalty weights for different indicator types
        private const val PENALTY_MAJOR = 0.3f       // Strong contradiction
        private const val PENALTY_MODERATE = 0.15f   // Moderate contradiction
        private const val PENALTY_MINOR = 0.05f      // Weak contradiction
        ...
        if (maxDepth > 20) {
            indicators.add(
                NegativeIndicator(
                    ...
                    penaltyWeight = PENALTY_MODERATE,
