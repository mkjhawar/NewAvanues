    ...
    fun loadConfig(): NumberOverlayConfig {
        return NumberOverlayConfig(
            ...
            styleVariant = StyleVariant.valueOf(
                prefs.getString(KEY_STYLE_VARIANT, StyleVariant.STANDARD.name) ?: StyleVariant.STANDARD.name
            ),
            anchorPoint = AnchorPoint.valueOf(
                prefs.getString(KEY_ANCHOR_POINT, AnchorPoint.TOP_RIGHT.name) ?: AnchorPoint.TOP_RIGHT.name
            ),
