...
class URLBarInteractionManager(
    ...
    fun focusURLBar(): Boolean {
        ...
        return try {
            ...
            Log.e(TAG, "Error focusing URL bar", e)
            false
        } finally {
            urlBarNode.recycle()
        }
    ...
    fun clearURLBar(): Boolean {
        ...
        return try {
            ...
            Log.e(TAG, "Error clearing URL bar", e)
            false
        } finally {
            urlBarNode.recycle()
        }
    ...
    private fun navigateViaVoice(url: String): Boolean {
        ...
        try {
            ...
            Log.e(TAG, "Error in voice navigation", e)
            return false
        }
    }
    ...
    private fun navigateViaAccessibility(url: String): Boolean {
        ...
        return try {
            ...
            Log.e(TAG, "Error in accessibility navigation", e)
            false
        } finally {
            urlBarNode.recycle()
        }
    ...
    private fun navigateViaKeyboard(url: String): Boolean {
        ...
        return try {
            ...
            Log.e(TAG, "Error in text injection navigation", e)
            false
        } finally {
            urlBarNode.recycle()
        }
    ...
    private fun setTextViaClipboard(node: AccessibilityNodeInfo, text: String): Boolean {
        return try {
            ...
            Log.e(TAG, "Error in clipboard method", e)
            false
        }
    }
