/**
 * VUIDMetricsRepository.kt - Repository for VUID metrics tracking
 *
 * Copyright (C) Manoj Jhawar/Aman Jhawar, Intelligent Devices LLC
 * Author: Manoj Jhawar
 * Created: 2025-12-17
 *
 * Stores and retrieves VUID creation and usage metrics.
 */
...
/**
 * VUID Metrics Repository
 *
 * Repository for tracking VUID creation and usage metrics.
 */
class VUIDMetricsRepository {

    private val _metricsFlow = MutableStateFlow(VUIDMetrics())
    val metricsFlow: Flow<VUIDMetrics> = _metricsFlow.asStateFlow()

    private val currentMetrics: VUIDMetrics
        get() = _metricsFlow.value

    /**
     * Record VUID creation
     */
