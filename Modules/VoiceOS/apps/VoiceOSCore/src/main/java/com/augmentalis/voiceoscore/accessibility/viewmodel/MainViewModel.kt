...
import com.augmentalis.voiceoscore.accessibility.client.VoiceRecognitionClient
    ...
    fun checkServiceStatus() {
        ...
        viewModelScope.launch {
            try {
                ...
                val serviceName = ComponentName(ctx, VoiceOSService::class.java).flattenToString()
