...
enum class AnchorPoint {
     ...
     * Use case: Left-to-right reading, avoid right-side content
     */
    TOP_LEFT,

    /**
     * Top-right corner of element (DEFAULT)
     * Use case: Most common notification badge position
     */
    TOP_RIGHT,

    /**
     * Bottom-left corner of element
     * Use case: Avoid top content like titles
     */
    BOTTOM_LEFT,

    /**
     * Bottom-right corner of element
     * Use case: Avoid both top and left content
     */
    BOTTOM_RIGHT
}
...
enum class ElementVoiceState {
    /**
     * Element has voice command name assigned
     * Color: Green - ready to use
     */
    ENABLED_WITH_NAME,

    /**
     * Element is voice-enabled but no command name set
     * Color: Orange - needs attention
     */
    ENABLED_NO_NAME,

    /**
     * Element is not voice-interactive
     * Color: Grey - disabled/unavailable
     */
    DISABLED
}
