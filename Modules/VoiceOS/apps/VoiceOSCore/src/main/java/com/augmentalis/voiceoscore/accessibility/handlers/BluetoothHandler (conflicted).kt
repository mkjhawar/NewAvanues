...
class BluetoothHandler(
    ...
    override fun execute(
        ...
        return when {
            ...
            action.contains("bluetooth on", ignoreCase = true) ||
            action.contains("bluetooth enable", ignoreCase = true) ||
            ...
            action.contains("bluetooth off", ignoreCase = true) ||
            action.contains("bluetooth disable", ignoreCase = true) ||
            ...
            // Toggle Bluetooth
            action.contains("bluetooth toggle", ignoreCase = true) ||
            action.contains("toggle bluetooth", ignoreCase = true) -> {
                toggleBluetooth()
            }

            // Open Bluetooth settings
            action.contains("bluetooth settings", ignoreCase = true) ||
