...
import com.augmentalis.voiceos.cursor.core.AnimationState
import com.augmentalis.voiceos.cursor.core.AnimationType
import com.augmentalis.voiceos.cursor.core.CursorAnimator
...
import com.augmentalis.voiceos.cursor.core.CursorRenderer
import com.augmentalis.voiceos.cursor.core.CursorState
import com.augmentalis.voiceos.cursor.core.CursorType
import com.augmentalis.voiceos.cursor.core.FilterStrength
import com.augmentalis.voiceos.cursor.core.GazeClickManager
import com.augmentalis.voiceos.cursor.core.GestureEvent
import com.augmentalis.voiceos.cursor.core.GestureManager
import com.augmentalis.voiceos.cursor.core.GestureType
import com.augmentalis.voiceos.cursor.core.ResourceProvider
...
class CursorView @JvmOverloads constructor(
    ...
    fun startTracking() {
        ...
        // Note: Accessibility service reference is now handled by CursorOverlayManager
    }
    ...
    private fun updateCursorPosition(position: CursorOffset) {
        if (!isCursorLocked) {
            ...
            // Position update is now handled by callback to parent manager
    ...
    private fun performGazeClick() {
        ...
        // Gaze click action is handled by callback to parent manager
        // The onGazeAutoClick callback above will be handled by CursorOverlayManager
    }
     ...
     */
    fun moveCursorTo(position: CursorOffset) {
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        Log.d(TAG, "onSizeChanged: position width = $w ,  height = $h")
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        //Log.d(TAG, "onDraw: position x = ${position.x} ,  position y = ${position.y}")
    ...
    private fun handleGestureEvent(gestureEvent: GestureEvent) {
        when (gestureEvent.type) {
            GestureType.TAP -> {
                ...
                provideHapticFeedback()
                // Click action should be handled by parent manager through callbacks
                Log.d(TAG, "Tap gesture detected at ${gestureEvent.currentPosition}")
            }
            ...
            GestureType.DOUBLE_TAP -> {
                ...
                // Provide haptic feedback
                provideHapticFeedback()
                // Double click action should be handled by parent manager through callbacks
                Log.d(TAG, "Double tap gesture detected at ${gestureEvent.currentPosition}")
            }
