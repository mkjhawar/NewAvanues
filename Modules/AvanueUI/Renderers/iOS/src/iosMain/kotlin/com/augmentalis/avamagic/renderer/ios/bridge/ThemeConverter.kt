package com.augmentalis.avamagic.renderer.ios.bridge
...
class iOSThemeConverter {
    ...
    data class iOSDesignTokens(
        ...
        val elevation: Map<String, ShadowValue>,
     ...
     */
    fun toSwiftUIElevation(elevation: ElevationScale): Map<String, ShadowValue> {
        return mapOf(
    ...
    private fun convertShadow(shadow: Shadow): ShadowValue {
        return ShadowValue(
