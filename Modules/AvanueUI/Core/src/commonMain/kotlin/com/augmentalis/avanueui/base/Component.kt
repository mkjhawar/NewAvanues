package com.augmentalis.avanueui.core
...
sealed class Modifier {
    ...
    data class Border(val border: com.augmentalis.avanueui.core.Border) : Modifier()
    data class CornerRadius(val radius: com.augmentalis.avanueui.core.CornerRadius) : Modifier()
    data class Shadow(val shadow: com.augmentalis.avanueui.core.Shadow) : Modifier()
    data class Opacity(val value: Float) : Modifier()
    data class Size(val width: com.augmentalis.avanueui.core.Size?, val height: com.augmentalis.avanueui.core.Size?) : Modifier()
    ...
    sealed class ClipShape {
        data class Rectangle(val radius: com.augmentalis.avanueui.core.CornerRadius = com.augmentalis.avanueui.core.CornerRadius.Zero) : ClipShape()
