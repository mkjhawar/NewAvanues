 ...
 *
 * @deprecated Use [SolColors] instead. Sunset maps to Sol palette in Theme v5.0.
 */
@Deprecated("Use SolColors instead", ReplaceWith("SolColors"))
object SunsetColors : AvanueColorScheme {
    ...
    // Containers
    override val primaryContainer = Color(0xFF5F2E1A)
    override val onPrimaryContainer = Color(0xFFFFD4C2)
    override val secondaryContainer = Color(0xFF5F4B0E)
    override val onSecondaryContainer = Color(0xFFFDE68A)
    override val tertiaryContainer = Color(0xFF4D1B3A)
