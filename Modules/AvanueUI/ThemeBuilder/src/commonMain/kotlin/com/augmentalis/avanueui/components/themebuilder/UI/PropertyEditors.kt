...
import com.augmentalis.avanueui.themebuilder.Engine.ColorPaletteGenerator
import com.augmentalis.avanueui.themebuilder.Engine.PaletteMode
...
object PropertyEditors {
    ...
    class FontSelector {
         ...
         * Current font
         */
        var currentFont: Font = Font("Roboto", 14f, Font.Weight.Regular)
            private set
         ...
         * Set font weight
         */
        fun setWeight(weight: Font.Weight) {
         ...
         */
        fun getAvailableWeights(): List<Font.Weight> = Font.Weight.values().toList()
