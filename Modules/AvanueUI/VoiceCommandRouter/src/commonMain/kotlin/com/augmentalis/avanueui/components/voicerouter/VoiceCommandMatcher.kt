package com.augmentalis.avanueui.voicerouter

import com.augmentalis.avanueui.argscanner.ARGFile
import com.augmentalis.avanueui.argscanner.ARGRegistry
import com.augmentalis.avanueui.argscanner.Capability
...
data class VoiceCommandMatch(
    val app: com.augmentalis.avanueui.argscanner.AppInfo,
...
private data class ParameterPlaceholder(
    val name: String,
    val position: Int,
    val type: com.augmentalis.avanueui.argscanner.ParamType?,
