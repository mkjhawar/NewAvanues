...
class TagInputHandler(
    ...
    override suspend fun execute(
        ...
        Log.d { "Processing tag input command: $normalizedAction" }
        ...
        return try {
            ...
            Log.e({ "Error executing tag input command" }, e)
    ...
    private suspend fun handleAddTag(
        ...
        return if (result.success) {
            ...
            Log.i { "Tag added: $tagName (total: $newCount)" }
    ...
    private suspend fun handleRemoveTag(
        ...
        return if (result.success) {
            ...
            Log.i { "Tag removed: $tagName (remaining: $remainingCount)" }
    ...
    private suspend fun handleRemoveLastTag(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Last tag removed: ${lastTag.name} (remaining: $remainingCount)" }
    ...
    private suspend fun handleClearTags(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "All tags cleared: $tagCount tags removed" }
    ...
    private suspend fun handleSelectTagByName(
        ...
        return if (result.success) {
            ...
            Log.i { "Tag selected: $tagName (index: ${tagIndex + 1})" }
    ...
    private suspend fun handleSelectTagByNumber(
        ...
        return if (result.success) {
            ...
            Log.i { "Tag $tagNumber selected: ${tagToSelect.name}" }
    ...
    private suspend fun handleFirstLastTag(
        ...
        return if (result.success) {
            ...
            Log.i { "$position tag selected: ${tagToSelect.name}" }
