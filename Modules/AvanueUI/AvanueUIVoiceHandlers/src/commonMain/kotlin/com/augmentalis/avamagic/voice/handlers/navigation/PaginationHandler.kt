...
class PaginationHandler(
    ...
    override suspend fun execute(
        ...
        Log.d { "Processing pagination command: $normalizedAction" }
        ...
        return try {
            ...
            Log.e({ "Error executing pagination command" }, e)
    ...
    private suspend fun handleRefresh(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Page refreshed: ${paginationInfo.name} page ${paginationInfo.currentPage}" }
    ...
    private suspend fun applyPageNavigation(
        ...
        return if (result.success) {
            ...
            Log.i { "Page navigation: ${paginationInfo.name} -> page $targetPage" }
    ...
    private suspend fun handleNavigationResult(
        ...
        return if (result.success) {
            ...
            Log.i { "Page navigation ($action): ${paginationInfo.name} -> page ${result.newPage}" }
    ...
    private suspend fun applyPageSizeChange(
        ...
        return if (result.success) {
            ...
            Log.i { "Page size changed: ${paginationInfo.name} -> $newPageSize items per page" }
