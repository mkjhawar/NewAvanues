...
class BottomNavHandler(
    ...
    override suspend fun execute(
        ...
        Log.d { "Processing bottom nav command: $normalizedAction" }
        ...
        return try {
            ...
            Log.e({ "Error executing bottom nav command" }, e)
    ...
    private suspend fun handleCurrentTab(command: QuantizedCommand): HandlerResult {
        ...
        Log.i { "Current tab: ${currentTab.label} (${navInfo.selectedIndex + 1}/${navInfo.tabs.size})" }
    ...
    private suspend fun navigateToTab(
        ...
        return if (result.success) {
            ...
            Log.i { "Tab selected: ${tab.label} (index $tabIndex)" }
