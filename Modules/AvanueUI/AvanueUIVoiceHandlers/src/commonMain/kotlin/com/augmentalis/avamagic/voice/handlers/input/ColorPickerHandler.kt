...
class ColorPickerHandler(
    ...
    override suspend fun execute(
        ...
        Log.d { "Processing color picker command: $normalizedAction" }
        ...
        return try {
            ...
            Log.e({ "Error executing color picker command" }, e)
    ...
    private suspend fun handleAdjustBrightness(
        ...
        return if (result.success) {
            ...
            Log.i { "Color brightness adjusted: ${pickerInfo.name} -> $directionWord" }
    ...
    private suspend fun handleAdjustSaturation(
        ...
        return if (result.success) {
            ...
            Log.i { "Color saturation adjusted: ${pickerInfo.name} -> $directionWord" }
    ...
    private suspend fun applyColorByName(
        ...
        return if (result.success) {
            ...
            Log.i { "Color set: ${pickerInfo.name} = $colorName ($hexColor)" }
    ...
    private suspend fun applyChannelChange(
        ...
        return if (result.success) {
            ...
            Log.i { "Color channel set: ${pickerInfo.name}.$channelName = $value" }
    ...
    private suspend fun applyAlphaChange(
        ...
        return if (result.success) {
            ...
            Log.i { "Color alpha set: ${pickerInfo.name}.alpha = $percentage%" }
    ...
    private suspend fun applyHexColor(
        ...
        return if (result.success) {
            ...
            Log.i { "Color set via hex: ${pickerInfo.name} = #$hexCode" }
