...
class SearchBarHandler(
    ...
    override suspend fun execute(
        ...
        Log.d { "Processing search bar command: $normalizedAction" }
        ...
        return try {
            ...
            Log.e({ "Error executing search bar command" }, e)
    ...
    private suspend fun handleSelectSuggestion(
        ...
        return if (result.success) {
            ...
            Log.i { "Selected suggestion $index: '$selectedSuggestion'" }
    ...
    private suspend fun handleSubmitSearch(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Submitted search: '$currentQuery'" }
