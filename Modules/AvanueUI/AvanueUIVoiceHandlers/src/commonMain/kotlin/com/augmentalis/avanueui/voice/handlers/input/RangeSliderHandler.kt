...
class RangeSliderHandler(
    ...
    override suspend fun execute(
        ...
        Log.d { "Processing range slider command: $normalizedAction" }
        ...
        return try {
            ...
            Log.e({ "Error executing range slider command" }, e)
    ...
    private suspend fun handleResetRange(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Range slider reset: ${sliderInfo.name}" }
    ...
    private suspend fun handleFullRange(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Range slider set to full range: ${sliderInfo.name}" }
    ...
    private suspend fun applyRange(
        ...
        return if (result.success) {
            ...
            Log.i { "Range slider values set: ${sliderInfo.name} = $lowValue - $highValue" }
    ...
    private suspend fun applyLowValue(sliderInfo: RangeSliderInfo, lowValue: Double): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Range slider low value set: ${sliderInfo.name} low = $lowValue" }
    ...
    private suspend fun applyHighValue(sliderInfo: RangeSliderInfo, highValue: Double): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Range slider high value set: ${sliderInfo.name} high = $highValue" }
