...
class ProgressHandler(
    ...
    override suspend fun execute(
        ...
        Log.d { "Processing progress command: $normalizedAction" }
        ...
        return try {
            ...
            Log.e({ "Error executing progress command" }, e)
    ...
    private suspend fun handleProgressStatus(
        ...
        Log.i { "Progress status: ${progressInfo.name} = $progressValue" }
    ...
    private suspend fun handleRemaining(
        ...
        Log.i { "Remaining progress: ${progressInfo.name} = $remaining%" }
    ...
    private suspend fun handleEta(
        ...
        Log.i { "ETA: ${progressInfo.name} = ${eta ?: "unknown"}ms" }
    ...
    private suspend fun handleCancel(
        ...
        return if (result.success) {
            ...
            Log.i { "Progress cancelled: ${progressInfo.name}" }
    ...
    private suspend fun handlePause(
        ...
        return if (result.success) {
            ...
            Log.i { "Progress paused: ${progressInfo.name}" }
    ...
    private suspend fun handleResume(
        ...
        return if (result.success) {
            ...
            Log.i { "Progress resumed: ${progressInfo.name}" }
    ...
    private suspend fun handleRetry(
        ...
        return if (result.success) {
            ...
            Log.i { "Progress retry: ${progressInfo.name}" }
    ...
    private suspend fun handleDetails(
        ...
        Log.i { "Progress details: ${progressInfo.name}" }
