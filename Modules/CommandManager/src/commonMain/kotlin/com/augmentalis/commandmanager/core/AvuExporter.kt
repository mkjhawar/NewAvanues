...
import com.augmentalis.commandmanager.AVUSerializer
import com.augmentalis.commandmanager.ExplorationStats
import com.augmentalis.commandmanager.QuantizedCommand
import com.augmentalis.commandmanager.QuantizedContext
...
data class AvuExportCommand(
    ...
    fun toQuantizedCommand(packageName: String): QuantizedCommand {
        return QuantizedCommand.create(
            avid = avid,
            phrase = trigger,
            actionType = com.augmentalis.commandmanager.CommandActionType.fromString(action),
