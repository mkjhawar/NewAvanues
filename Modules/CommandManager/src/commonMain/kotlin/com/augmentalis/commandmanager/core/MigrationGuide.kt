 ...
 * | VoiceOSCore/learnapp | `com.augmentalis.commandmanager.learnapp` | Deprecated |
 ...
 * | New Module | Package |
 * |------------|---------|
 * | VoiceOSCoreNG | `com.augmentalis.commandmanager.coreng` |
 *
 * ## Type Mappings
 *
 * ### ElementInfo
 ...
 * | Old | New |
 * |-----|-----|
 * | `com.augmentalis.learnappcore.models.ElementInfo` | `com.augmentalis.commandmanager.coreng.common.ElementInfo` |
 * | `android.graphics.Rect` (bounds) | `com.augmentalis.commandmanager.coreng.common.Bounds` |
 ...
 * val vuid = LearnAppCoreAdapter.migrateUuidToAvid(legacyUuid)
 ...
 * ```kotlin
 * // Phase 1: Use alias
 * import com.augmentalis.commandmanager.LearnAppElementInfo
 ...
 *             val vuid = LearnAppCoreAdapter.migrateUuidToAvid(element.uuid)
 *             if (vuid != null) {
 ...
 *
 * **Problem:** migrateUuidToAvid returns null.
 *
...
object MigrationGuide {
    ...
    fun migrateIdentifier(identifier: String): String {
        return if (requiresMigration(identifier)) {
            LearnAppCoreAdapter.migrateUuidToAvid(identifier) ?: identifier
        } else {
            identifier
        }
    }
