...
// Source: com.augmentalis.rpc.ava.ActionResponse in ava.proto
@file:Suppress(
  "DEPRECATION",
...
public class ActionResponse(
...
) : Message<ActionResponse, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ActionResponse) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ActionResponse{", separator = ", ", postfix = "}")
  }
  ...
  ): ActionResponse = ActionResponse(request_id, success, message, result_json, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ActionResponse> = object : ProtoAdapter<ActionResponse>(
      FieldEncoding.LENGTH_DELIMITED, 
      ActionResponse::class, 
      "type.googleapis.com/com.augmentalis.rpc.ava.ActionResponse", 
      PROTO_3, 
      null, 
      "ava.proto"
    ) {
      override fun encodedSize(`value`: ActionResponse): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: ActionResponse) {
        if (value.request_id != "") {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: ActionResponse) {
        writer.writeBytes(value.unknownFields)
        if (value.result_json != "") {
          ProtoAdapter.STRING.encodeWithTag(writer, 4, value.result_json)
        }
      ...
      override fun decode(reader: ProtoReader): ActionResponse {
      ...
      override fun redact(`value`: ActionResponse): ActionResponse = value.copy(
