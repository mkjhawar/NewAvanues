...
// Source: com.augmentalis.rpc.cockpit.CockpitResponse in cockpit.proto
@file:Suppress(
  "DEPRECATION",
...
public class CockpitResponse(
...
) : Message<CockpitResponse, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is CockpitResponse) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "CockpitResponse{", separator = ", ", postfix = "}")
  }
  ...
  ): CockpitResponse = CockpitResponse(request_id, success, message, result_json, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<CockpitResponse> = object : ProtoAdapter<CockpitResponse>(
      FieldEncoding.LENGTH_DELIMITED, 
      CockpitResponse::class, 
      "type.googleapis.com/com.augmentalis.rpc.cockpit.CockpitResponse", 
      PROTO_3, 
      null, 
      "cockpit.proto"
    ) {
      override fun encodedSize(`value`: CockpitResponse): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: CockpitResponse) {
        if (value.request_id != "") {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: CockpitResponse) {
        writer.writeBytes(value.unknownFields)
        if (value.result_json != "") {
          ProtoAdapter.STRING.encodeWithTag(writer, 4, value.result_json)
        }
      ...
      override fun decode(reader: ProtoReader): CockpitResponse {
      ...
      override fun redact(`value`: CockpitResponse): CockpitResponse = value.copy(
