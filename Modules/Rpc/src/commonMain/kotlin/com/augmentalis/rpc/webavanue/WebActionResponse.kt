...
// Source: com.augmentalis.rpc.webavanue.WebActionResponse in webavanue.proto
@file:Suppress(
  "DEPRECATION",
...
public class WebActionResponse(
...
) : Message<WebActionResponse, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is WebActionResponse) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "WebActionResponse{", separator = ", ", postfix = "}")
  }
  ...
  ): WebActionResponse = WebActionResponse(request_id, success, message, result_json, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<WebActionResponse> = object : ProtoAdapter<WebActionResponse>(
      FieldEncoding.LENGTH_DELIMITED, 
      WebActionResponse::class, 
      "type.googleapis.com/com.augmentalis.rpc.webavanue.WebActionResponse", 
      PROTO_3, 
      null, 
      "webavanue.proto"
    ) {
      override fun encodedSize(`value`: WebActionResponse): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: WebActionResponse) {
        if (value.request_id != "") {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: WebActionResponse) {
        writer.writeBytes(value.unknownFields)
        if (value.result_json != "") {
          ProtoAdapter.STRING.encodeWithTag(writer, 4, value.result_json)
        }
      ...
      override fun decode(reader: ProtoReader): WebActionResponse {
      ...
      override fun redact(`value`: WebActionResponse): WebActionResponse = value.copy(
