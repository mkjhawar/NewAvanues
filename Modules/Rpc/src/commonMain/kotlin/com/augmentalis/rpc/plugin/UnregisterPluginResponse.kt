...
// Source: com.augmentalis.rpc.plugin.UnregisterPluginResponse in plugin.proto
@file:Suppress(
  "DEPRECATION",
 ...
 */
public class UnregisterPluginResponse(
  @field:WireField(
    tag = 1,
...
) : Message<UnregisterPluginResponse, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is UnregisterPluginResponse) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "UnregisterPluginResponse{", separator = ", ", postfix = "}")
  }
  ...
  ): UnregisterPluginResponse = UnregisterPluginResponse(request_id, success, message, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<UnregisterPluginResponse> = object : ProtoAdapter<UnregisterPluginResponse>(
      FieldEncoding.LENGTH_DELIMITED,
      UnregisterPluginResponse::class,
      "type.googleapis.com/com.augmentalis.rpc.plugin.UnregisterPluginResponse",
      PROTO_3,
      null,
      "plugin.proto"
    ) {
      override fun encodedSize(`value`: UnregisterPluginResponse): Int {
      ...
      override fun decode(reader: ProtoReader): UnregisterPluginResponse {
      ...
      override fun redact(`value`: UnregisterPluginResponse): UnregisterPluginResponse = value.copy(
