...
// ============================================================================
// QuantizedCommand ↔ GeneratedCommandDTO Conversion
// ============================================================================
...
private fun QuantizedCommand.toGeneratedCommandDTO(): GeneratedCommandDTO {
    ...
    require(!packageName.isNullOrBlank()) {
        ...
        "Command: phrase='$phrase', targetVuid='$targetVuid'"
    }

    // Use elementHash from metadata if available, otherwise fall back to targetVuid/uuid
    val elementHash = metadata["elementHash"]
        ?: targetVuid
        ?: uuid.ifBlank { packageName.hashCode().toUInt().toString(16) }
