...
import com.augmentalis.voiceoscoreng.common.ExplorationStats
...
/**
 * Generated command for AVU export (simplified representation).
 */
data class GeneratedCommand(
    ...
    fun toQuantizedCommand(packageName: String): QuantizedCommand {
        return QuantizedCommand.create(
            avid = avid,
            phrase = trigger,
            actionType = com.augmentalis.voiceoscoreng.common.CommandActionType.fromString(action),
    ...
    companion object {
         ...
         */
        fun fromQuantizedCommand(cmd: QuantizedCommand): GeneratedCommand {
...
class AvuExporter(
    ...
    private fun countDataLines(context: QuantizedContext, commands: List<GeneratedCommand>): Int {
    ...
    private fun calculateStats(context: QuantizedContext, commands: List<GeneratedCommand>): ExplorationStats {
