...
data class SpeechError(
    ...
    companion object {
        ...
        fun permissionError(message: String? = null): SpeechError {
            return SpeechError(
                code = ERROR_PERMISSIONS,
                message = message ?: "Permission denied",
                isRecoverable = true,
                suggestedAction = Action.REQUEST_PERMISSIONS
            )
        }

        fun modelError(message: String? = null): SpeechError {
            return SpeechError(
                code = ERROR_MODEL,
                message = message ?: "Model not available",
                isRecoverable = true,
                suggestedAction = Action.DOWNLOAD_MODEL
            )
        }
    }
}
