 ...
 *
 * Provides thread-safe storage and matching for static commands,
 * dynamic commands, and vocabulary.
 */
...
class CommandCache {
    ...
    private val staticCommands = createSynchronizedList<String>()
    private val dynamicCommands = createSynchronizedList<String>()
    private val vocabularyCache = createConcurrentMap<String, Boolean>()
    ...
    fun getAllCommands(): List<String> {
        ...
        allCommands.addAll(staticCommands.toList())
        allCommands.addAll(dynamicCommands.toList())
        allCommands.addAll(vocabularyCache.filter { it.value }.keys.toList())
     ...
     */
    fun getStaticCommands(): List<String> = staticCommands.toList()

    /**
     * Get dynamic commands only
     */
    fun getDynamicCommands(): List<String> = dynamicCommands.toList()
