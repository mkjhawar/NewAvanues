/**
 * SpeechErrorCodes.kt - Consolidated error codes for all speech recognition engines
 *
 ...
 *
 * Consolidated from duplicate SpeechError declarations across engine files
