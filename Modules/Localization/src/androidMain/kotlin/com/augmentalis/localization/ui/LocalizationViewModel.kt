...
import com.augmentalis.localization.data.DebounceDuration
import com.augmentalis.localization.data.DetailLevel
...
open class LocalizationViewModel(
    ...
    private val localizationModule = Localizer.getInstance(context)
    ...
    private fun loadAvailableLanguages() {
        ...
        // Add VOSK languages
        Localizer.VOSK_LANGUAGES.forEach { code ->
        ...
        Localizer.VIVOKA_LANGUAGES.forEach { (code, name) ->
    ...
    private fun getLanguageName(code: String): String {
        return Localizer.VIVOKA_LANGUAGES[code] ?: Locale(code).displayName
    }
