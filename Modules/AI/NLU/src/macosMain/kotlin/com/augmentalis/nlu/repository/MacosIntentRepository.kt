/**
 * MacosIntentRepository - macOS implementation of IntentRepository
 *
 * Uses SQLDelight with NativeSqliteDriver for persistent storage on macOS.
 * Mirrors IosIntentRepository with Dispatchers.Default (IO is internal on Native).
 */
...
/**
 * macOS implementation of IntentRepository.
 */
class MacosIntentRepository(
...
actual object IntentRepositoryFactory {
    actual fun create(context: Any?): IntentRepository {
        ...
        return MacosIntentRepository(database)
    }
}
