/**
 * DesktopIntentRepository - Desktop/JVM implementation of IntentRepository
 *
 * Uses SQLDelight with JVM JDBC SQLite driver for persistent storage.
 *
 * Created: 2026-01-18
 */
 ...
 *
 * Uses SQLDelight with JDBC SQLite driver for cross-platform database access.
 * Database stored at ~/.ava/nlu/shared_nlu.db
 */
 ...
 *
 * Creates SQLDelight database with JVM JDBC driver.
