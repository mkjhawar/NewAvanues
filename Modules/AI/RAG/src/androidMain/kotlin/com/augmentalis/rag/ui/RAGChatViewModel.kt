...
import com.augmentalis.rag.chat.*
...
class RAGChatViewModel(
     ...
     */
    private fun convertToMessageHistory(): List<com.augmentalis.rag.chat.Message> {
        return _messages.value
            .filter { !it.isStreaming } // Exclude streaming messages
            .map { uiMessage ->
                com.augmentalis.rag.chat.Message(
                    role = when (uiMessage.role) {
                        MessageRole.USER -> com.augmentalis.rag.chat.MessageRole.USER
                        MessageRole.ASSISTANT -> com.augmentalis.rag.chat.MessageRole.ASSISTANT
                        MessageRole.SYSTEM -> com.augmentalis.rag.chat.MessageRole.SYSTEM
                    },
