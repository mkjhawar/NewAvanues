...
class MyApp : Application() {
    override fun onCreate() {
        ...
        val theme = ThemeManager.getTheme("com.voiceavanue.mobile")

        // Option 2: Override for this app only
        ThemeManager.setAppTheme(
            appId = "com.voiceavanue.mobile",
            theme = Themes.iOS26LiquidGlass
        )

        // Option 3: Partial override (inherit most, change some)
        val customTheme = ThemeManager.getTheme("com.voiceavanue.mobile").copy(
            colorScheme = myCustomColors
        )
        ThemeManager.setAppTheme("com.voiceavanue.mobile", customTheme)
    }
}
```
...
##### App Override File
```json
// Universal/Core/ThemeManager/themes/apps/com.voiceavanue.mobile.json
{
  "appId": "com.voiceavanue.mobile",
  "version": "1.0.0",
...
class CloudinaryAssetCDN : AssetCDN {
    override suspend fun upload(asset: Asset): String {
        ...
        // Returns: https://res.cloudinary.com/voiceavanue/image/upload/v123/icon.png
    }
}
