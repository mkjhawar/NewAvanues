...
/**
 * Android implementation of SignatureVerifier using Android Security APIs.
 */
actual class SignatureVerifier {
    ...
    actual fun verifyEmbedded(
        ...
        try {
            ...
            // Decode Base64 signature (using Android Base64)
            val signatureBytes = Base64.decode(embeddedSignature, Base64.DEFAULT)
