...
class AVUExporter(
    ...
    companion object {
        ...
        private const val SCHEMA_VERSION = "avu-2.2"
        private const val FORMAT_VERSION = "2.2.0"
    ...
    fun export(
        ...
        try {
            // Header comments
            lines.add("# Avanues Universal Format v2.2")
            lines.add("# Type: VOS")
            lines.add("# Extension: .vos")
            lines.add("# Generated by: LearnApp v2.2")
