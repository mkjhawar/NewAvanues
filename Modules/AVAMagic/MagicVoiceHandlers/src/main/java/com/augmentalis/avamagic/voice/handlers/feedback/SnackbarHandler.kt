...
class SnackbarHandler(
    ...
    override suspend fun execute(
        ...
        Log.d(TAG, "Processing snackbar command: $normalizedAction")
        ...
        return try {
            ...
            Log.e(TAG, "Error executing snackbar command", e)
    ...
    private suspend fun handleAction(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Snackbar action triggered: ${snackbarInfo.actionLabel}")
    ...
    private suspend fun handleReadMessage(command: QuantizedCommand): HandlerResult {
        ...
        Log.i(TAG, "Reading snackbar content: $messageToRead")
