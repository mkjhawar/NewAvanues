...
class TabsHandler(
    ...
    override suspend fun execute(
        ...
        Log.d(TAG, "Processing tab command: $normalizedAction")
        ...
        return try {
            ...
            Log.e(TAG, "Error executing tab command", e)
    ...
    private suspend fun handleNextTab(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Switched to next tab: ${result.newTabName} (${result.newTabIndex + 1}/${tabsInfo.tabs.size})")
    ...
    private suspend fun handlePreviousTab(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Switched to previous tab: ${result.newTabName} (${result.newTabIndex + 1}/${tabsInfo.tabs.size})")
    ...
    private suspend fun handleCloseTab(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Closed tab: ${currentTab.name}")
    ...
    private suspend fun handleCloseTabByName(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Closed tab: ${targetTab.name}")
    ...
    private suspend fun handleNewTab(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Created new tab: ${result.newTabName}")
    ...
    private suspend fun switchToTabByIndex(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Switched to tab: ${targetTab.name} (${targetIndex + 1}/${tabsInfo.tabs.size})")
    ...
    private suspend fun switchToTabByName(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Switched to tab: ${targetTab.name} (${targetTab.index + 1}/${tabsInfo.tabs.size})")
