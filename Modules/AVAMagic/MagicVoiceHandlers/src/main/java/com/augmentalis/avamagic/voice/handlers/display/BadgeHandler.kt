...
class BadgeHandler(
    ...
    override suspend fun execute(
        ...
        Log.d(TAG, "Processing badge command: $normalizedAction")
        ...
        return try {
            ...
            Log.e(TAG, "Error executing badge command", e)
    ...
    private suspend fun applyBadge(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Badge updated: ${badgeInfo.name} = $count, visible = $visible")
