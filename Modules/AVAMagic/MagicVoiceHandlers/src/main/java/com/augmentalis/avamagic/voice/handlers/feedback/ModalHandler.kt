...
class ModalHandler(
    ...
    override suspend fun execute(
        ...
        Log.d(TAG, "Processing modal command: $normalizedAction")
        ...
        return try {
            ...
            Log.e(TAG, "Error executing modal command", e)
    ...
    private suspend fun handleClose(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Modal closed: ${modalInfo.title ?: "Untitled"}")
    ...
    private suspend fun handleConfirm(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Modal confirmed: ${modalInfo.title ?: "Untitled"}")
    ...
    private suspend fun handleCancel(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Modal cancelled: ${modalInfo.title ?: "Untitled"}")
    ...
    private suspend fun handleButtonByNumber(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Modal button clicked: $buttonLabel")
    ...
    private suspend fun handleButtonByName(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Modal button clicked: $matchedButton")
