...
class ChipHandler(
    ...
    override suspend fun execute(
        ...
        Log.d(TAG, "Processing chip command: $normalizedAction")
        ...
        return try {
            ...
            Log.e(TAG, "Error executing chip command", e)
    ...
    private suspend fun handleClearChips(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Cleared $clearedCount chip selections")
    ...
    private suspend fun applySelection(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Chip selection: ${chipInfo.name} = $selected")
