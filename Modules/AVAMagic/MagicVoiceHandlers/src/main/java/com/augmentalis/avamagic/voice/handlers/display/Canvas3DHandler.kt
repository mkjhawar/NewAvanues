...
class Canvas3DHandler(
    ...
    override suspend fun execute(
        ...
        Log.d(TAG, "Processing 3D canvas command: $normalizedAction")
        ...
        return try {
            ...
            Log.e(TAG, "Error executing 3D canvas command", e)
    ...
    private suspend fun handleToggleAutoRotate(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Auto-rotate $action for canvas: ${canvasInfo.name}")
    ...
    private suspend fun handleResetView(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "View reset for canvas: ${canvasInfo.name}")
    ...
    private suspend fun handleViewPreset(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Preset view $presetName set for canvas: ${canvasInfo.name}")
    ...
    private suspend fun handlePan(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Panned $direction for canvas: ${canvasInfo.name}")
    ...
    private suspend fun handleSelect(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Selected object '$objectName' in canvas: ${canvasInfo.name}")
    ...
    private suspend fun handleClearSelection(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Selection cleared for canvas: ${canvasInfo.name}")
    ...
    private suspend fun handleRenderMode(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Render mode set to $modeName for canvas: ${canvasInfo.name}")
    ...
    private fun buildRotationResult(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Rotated $direction ${degrees}deg for canvas: ${canvasInfo.name}")
    ...
    private fun buildZoomResult(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Zoom set to $zoomLevel% for canvas: ${canvasInfo.name}")
