...
class IconPickerHandler(
    ...
    override suspend fun execute(
        ...
        Log.d(TAG, "Processing icon picker command: $normalizedAction")
        ...
        return try {
            ...
            Log.e(TAG, "Error executing icon picker command", e)
    ...
    private suspend fun handleSelectByName(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Icon selected: ${result.selectedIconName}")
    ...
    private suspend fun handleSearch(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Search performed: '$query' returned $resultCount results")
    ...
    private suspend fun handleSelectByIndex(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Icon selected by index: $index -> ${result.selectedIconName}")
    ...
    private suspend fun handleCategoryFilter(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Category filter applied: $matchedCategory")
    ...
    private suspend fun handleNext(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Navigated to next icon: ${result.selectedIconName}")
    ...
    private suspend fun handlePrevious(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Navigated to previous icon: ${result.selectedIconName}")
    ...
    private suspend fun handleNextPage(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Navigated to next page: $newPage")
    ...
    private suspend fun handlePreviousPage(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Navigated to previous page: $newPage")
    ...
    private suspend fun handleShowAll(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Showing all icons (filters cleared)")
