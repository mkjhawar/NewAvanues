...
class AutocompleteHandler(
    ...
    override suspend fun execute(
        ...
        Log.d(TAG, "Processing autocomplete command: $normalizedAction")
        ...
        return try {
            ...
            Log.e(TAG, "Error executing autocomplete command", e)
    ...
    private suspend fun handleTypeText(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Text typed: $textToType in ${autocompleteInfo.name}")
    ...
    private suspend fun handleClearInput(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Input cleared: ${autocompleteInfo.name}")
    ...
    private suspend fun handleShowSuggestions(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Suggestions shown: ${autocompleteInfo.name}")
    ...
    private suspend fun handleHideSuggestions(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Suggestions hidden: ${autocompleteInfo.name}")
    ...
    private suspend fun selectOption(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Option selected: $selectedOption (index $index) in ${autocompleteInfo.name}")
