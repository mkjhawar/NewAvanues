...
class AppBarHandler(
    ...
    override suspend fun execute(
        ...
        Log.d(TAG, "Processing app bar command: $normalizedAction")
        ...
        return try {
            ...
            Log.e(TAG, "Error executing app bar command", e)
    ...
    private suspend fun handleBack(command: QuantizedCommand): HandlerResult {
        ...
        if (appBarInfo?.hasBackButton == true) {
            ...
            if (result.success) {
                ...
                Log.i(TAG, "Back navigation via app bar button")
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Back navigation via system")
    ...
    private suspend fun handleOpenMenu(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Navigation menu opened")
            HandlerResult.Success(
                message = "Menu opened",
                data = mapOf(
                    "action" to "open_menu",
    ...
    private suspend fun handleOverflowMenu(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Overflow menu opened")
            HandlerResult.Success(
