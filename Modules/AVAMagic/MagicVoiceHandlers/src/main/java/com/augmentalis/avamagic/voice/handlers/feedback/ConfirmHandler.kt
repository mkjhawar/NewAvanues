...
class ConfirmHandler(
    ...
    override suspend fun execute(
        ...
        Log.d(TAG, "Processing confirmation command: $normalizedAction")
        ...
        return try {
            ...
            Log.e(TAG, "Error executing confirmation command", e)
    ...
    private suspend fun handleConfirm(
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Confirmation: $message - ${confirmInfo.question}")
    ...
    private suspend fun handleCancel(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i(TAG, "Cancellation: ${confirmInfo.question}")
    ...
    private suspend fun handleReadQuestion(command: QuantizedCommand): HandlerResult {
        ...
        Log.i(TAG, "Reading confirmation prompt: $messageToRead")
