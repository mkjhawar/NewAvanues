...
class AvatarHandler(
    ...
    override suspend fun execute(
        ...
        Log.d { "Processing avatar command: $normalizedAction" }
        ...
        return try {
            ...
            Log.e({ "Error executing avatar command" }, e)
    ...
    private suspend fun performViewAction(avatarInfo: AvatarInfo): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Avatar viewed: ${avatarInfo.userName}" }
    ...
    private suspend fun performChangeAction(
        ...
        return if (result.success) {
            ...
            Log.i { "Avatar change initiated: ${avatarInfo.userName} via $source" }
    ...
    private suspend fun performRemoveAction(avatarInfo: AvatarInfo): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Avatar removed: ${avatarInfo.userName}" }
