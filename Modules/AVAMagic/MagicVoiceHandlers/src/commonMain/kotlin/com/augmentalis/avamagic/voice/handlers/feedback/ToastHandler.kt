...
class ToastHandler(
    ...
    fun recordToast(toast: ToastInfo) {
        ...
        Log.d { "Toast recorded: ${toast.message}" }
    }
    ...
    override suspend fun execute(
        ...
        Log.d { "Processing toast command: $normalizedAction" }
        ...
        return try {
            ...
            Log.e({ "Error executing toast command" }, e)
    ...
    private suspend fun handleReadToast(command: QuantizedCommand): HandlerResult {
        ...
        Log.i { "Reading toast content: $messageToRead" }
    ...
    private suspend fun handleRepeat(command: QuantizedCommand): HandlerResult {
        ...
        Log.i { "Repeating toast: $messageToRead" }
