...
class AlertHandler(
    ...
    override suspend fun execute(
        ...
        Log.d { "Processing alert command: $normalizedAction" }
        ...
        return try {
            ...
            Log.e({ "Error executing alert command" }, e)
    ...
    private suspend fun handleDismiss(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Alert dismissed: ${alertInfo.title ?: "Untitled"}" }
    ...
    private suspend fun handleAcknowledge(command: QuantizedCommand): HandlerResult {
        ...
        return if (result.success) {
            ...
            Log.i { "Alert acknowledged: ${alertInfo.title ?: "Untitled"}" }
    ...
    private suspend fun handleReadAlert(command: QuantizedCommand): HandlerResult {
        ...
        Log.i { "Reading alert content: $messageToRead" }
