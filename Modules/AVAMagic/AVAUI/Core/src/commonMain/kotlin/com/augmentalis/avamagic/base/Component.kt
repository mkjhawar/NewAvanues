...
sealed class Modifier {
    ...
    data class Border(val border: com.augmentalis.avamagic.components.core.Border) : Modifier()
    data class CornerRadius(val radius: com.augmentalis.avamagic.components.core.CornerRadius) : Modifier()
    data class Shadow(val shadow: com.augmentalis.avamagic.components.core.Shadow) : Modifier()
    data class Opacity(val value: Float) : Modifier()
    data class Size(val width: com.augmentalis.avamagic.components.core.Size?, val height: com.augmentalis.avamagic.components.core.Size?) : Modifier()
    ...
    sealed class ClipShape {
        data class Rectangle(val radius: com.augmentalis.avamagic.components.core.CornerRadius = com.augmentalis.avamagic.components.core.CornerRadius.Zero) : ClipShape()
