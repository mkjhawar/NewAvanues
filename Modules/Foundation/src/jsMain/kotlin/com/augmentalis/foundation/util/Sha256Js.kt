...
/**
 * JS implementation of SHA-256 using pure Kotlin.
 *
 * Provides a synchronous SHA-256 hash that works in both browser and Node.js
 * environments without requiring async SubtleCrypto or external dependencies.
 */
