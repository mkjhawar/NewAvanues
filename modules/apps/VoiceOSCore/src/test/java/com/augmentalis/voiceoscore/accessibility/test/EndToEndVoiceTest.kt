...
class MockVoiceRecognitionService {
    ...
    @Suppress("UNUSED_PARAMETER") // Engine and language parameters not needed in mock implementation
...
class EndToEndVoiceTest {
    ...
    private var mockAccessibilityService: VoiceOSService? = null
     ...
     */
    @Suppress("UNUSED_PARAMETER") // Context parameter not needed in mock setup
    ...
    fun testCompleteVoiceFlow(
        ...
        @Suppress("UNUSED_PARAMETER") _timeout: Long = TEST_TIMEOUT_MS // Timeout parameter not used in current implementation
    ): EndToEndTestResult {
     ...
     */
    @Suppress("UNUSED_PARAMETER") // Timeout parameter not used in current implementation
    ...
    private fun verifyCommandRouting(
        expectedCategory: ActionCategory,
        expectedAction: String,
        @Suppress("UNUSED_PARAMETER") _timeout: Long // Timeout parameter not used in current implementation
    ): RoutingResult {
        val startTime = System.currentTimeMillis()
        val errors = mutableListOf<String>()
     ...
     */
    @Suppress("UNUSED_PARAMETER") // Context parameter passed to setupTestEnvironment which handles it
