/**
 * Avanues - Consolidated Modular Platform
 *
 * Single app with dual launcher icons (VoiceAvanue + WebAvanue).
 * Combines all modules via the VoiceAvanue KMP foundation:
 * - VoiceAvanue module: Foundation layer (VoiceOSCore + WebAvanue + shared resources)
 * - VoiceOSCore: Voice commands, accessibility, screen scraping, AVU DSL
 * - WebAvanue: Full browser with tabs, bookmarks, history, XR
