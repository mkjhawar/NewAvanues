/**
 * AVA Unified - Integrated Voice, Browser, and Accessibility Platform
 *
 * Combines:
 * - VoiceOSCore: Voice commands, accessibility control, screen scraping
 * - WebAvanue: Voice-controlled browser with custom search engines
...
android {
    namespace = "com.augmentalis.avaunified"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.augmentalis.avaunified"
        minSdk = 29
        targetSdk = 34
        versionCode = 1
