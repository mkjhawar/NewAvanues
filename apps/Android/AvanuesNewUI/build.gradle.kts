/**
 * AvanuesNewUI - Simplified Voice-First UI App
 *
 * Clone of the Avanues consolidated app that defaults to the new simplified
 * voice-first UI (Lens shell mode) instead of the classic dashboard.
 * Same feature set, same modules, new default experience.
 *
...
android {
    ...
    defaultConfig {
        applicationId = "com.augmentalis.avanuesnewui"
        minSdk = 29
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0-newui-alpha01"
