# Compact DSL Format Specification
...
The Compact DSL Format is a domain-specific language for serializing UI component trees in the AVAMagic/Avanues ecosystem. It provides a human-readable, efficient alternative to JSON for inter-process communication (IPC) and component serialization.
...
### 12.1 Complete Grammar (Railroad Diagram Style)
