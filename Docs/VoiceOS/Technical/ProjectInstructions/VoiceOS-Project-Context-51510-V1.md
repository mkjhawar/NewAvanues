...
- **Repository Location:** `/Volumes/M Drive/Coding/vos4`
...
cd /Volumes/M\ Drive/Coding/vos4/coding/TODO/
cd /Volumes/M\ Drive/Coding/vos4/coding/STATUS/
cd /Volumes/M\ Drive/Coding/vos4/coding/ISSUES/

# System documentation
cd /Volumes/M\ Drive/Coding/vos4/docs/voiceos-master/

# Module code (example: VoiceAccessibility)
cd /Volumes/M\ Drive/Coding/vos4/modules/apps/VoiceAccessibility/

# Module documentation (example: voice-accessibility)
cd /Volumes/M\ Drive/Coding/vos4/docs/modules/voice-accessibility/
```
...
- **Coding Protocol:** `/Volumes/M Drive/Coding/vos4/Docs/ProjectInstructions/Protocol-VOS4-Coding-Standards.md`
- **Documentation Protocol:** `/Volumes/M Drive/Coding/vos4/Docs/ProjectInstructions/Protocol-VOS4-Documentation.md`
- **Commit Protocol:** `/Volumes/M Drive/Coding/vos4/Docs/ProjectInstructions/Protocol-VOS4-Commit.md`
- **Q&A Protocol:** `/Volumes/M Drive/Coding/vos4/Docs/ProjectInstructions/Protocol-VOS4-Pre-Implementation-QA.md`
