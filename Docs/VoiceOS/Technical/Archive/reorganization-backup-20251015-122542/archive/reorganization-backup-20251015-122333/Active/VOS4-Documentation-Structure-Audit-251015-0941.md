...
Audit of `/Volumes/M Drive/Coding/Warp/vos4/docs` identified **structural issues** that need correction:
...
BACKUP_DIR="/Volumes/M Drive/Coding/Warp/vos4/docs/archive/backups/pre-reorganization-251015-0941"
mkdir -p "$BACKUP_DIR"
