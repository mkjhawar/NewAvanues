...
class VivokaState {
    ...
    // Service state management using shared component
    ...
    data class VivokaStateSnapshot(
        ...
        val serviceState: ServiceState.State,
    ...
    fun enterRecoveryMode() {
        ...
        isRecovering = true
        serviceState.setState(ServiceState.State.ERROR, "Recovery in progress")
    ...
    fun exitRecoveryMode(successful: Boolean) {
        ...
        if (successful) {
            ...
            serviceState.setState(ServiceState.State.ERROR, "Recovery failed")
        }
    ...
    private fun getCurrentStateSnapshot(): VivokaStateSnapshot {
        return VivokaStateSnapshot(
            ...
            serviceState = serviceState.currentState,
    ...
    fun getStateSummary(): Map<String, Any> {
        return mapOf(
            ...
            "serviceState" to serviceState.currentState,
