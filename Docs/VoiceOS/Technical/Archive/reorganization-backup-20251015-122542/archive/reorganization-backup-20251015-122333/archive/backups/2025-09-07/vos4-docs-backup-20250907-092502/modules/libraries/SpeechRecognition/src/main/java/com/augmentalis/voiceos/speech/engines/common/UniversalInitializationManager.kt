 ...
 * - "Cannot call 'Vsdk.init' multiple times" errors
 * - Race conditions in SpeechViewModel
...
class UniversalInitializationManager private constructor() {
     ...
     * @param initFunction The actual initialization function to execute
        ...
        if (config.allowDegradedMode) {
            ...
            try {
                val degradedResult = withTimeoutOrNull(config.timeoutMs / 2) {
                    ...
                    // This would be implemented by each engine
                    false // Placeholder
                }
