/**
 * ComposeExtensions.kt - Jetpack Compose extensions for UUIDManager
 * Path: libraries/UUIDManager/src/main/java/com/ai/uuidmgr/compose/ComposeExtensions.kt
 * 
 * Author: Manoj Jhawar
...
package com.augmentalis.uuidmanager.compose
...
fun Modifier.withUUID(
    manager: UUIDManager = UUIDManager.instance,
    uuid: String? = null,
    name: String? = null,
...
fun VoiceCommandHandler(
    manager: UUIDManager = UUIDManager.instance,
    onCommandReceived: suspend (String) -> Unit = { command ->
