    ...
    private fun createRoundCursor(size: Int, color: Int, resourceId: Int): Bitmap? {
        return try {
            ...
            val tintColor = when {
                ...
                color > Int.MAX_VALUE -> color.toInt() // Convert Long to Int
                else -> color
            }
...
class ResourceProvider(private val context: Context) {
    // Map cursor types to actual VoiceCursor drawable resources
    fun getHandCursorResource(): Int = com.augmentalis.voiceos.cursor.R.drawable.cursor_hand
    fun getRoundCursorResource(): Int = com.augmentalis.voiceos.cursor.R.drawable.cursor_round
    ...
    // Support all cursor shape options from settings
    fun getCursorResourceByName(resourceName: String): Int = when(resourceName) {
        ...
        else -> com.augmentalis.voiceos.cursor.R.drawable.cursor_round // fallback to round cursor
    }
}