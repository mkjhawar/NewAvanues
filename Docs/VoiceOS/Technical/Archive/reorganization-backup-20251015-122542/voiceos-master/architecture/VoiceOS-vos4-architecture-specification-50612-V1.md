...
graph TB
    ...
    subgraph "Library Tier"
        ...
        L3[UUIDCreator<br/>Element Targeting]
...
│                    LIBRARY TIER                             │
├─────────────┬─────────────┬─────────────┬─────────────┬─────┤
│SpeechRecog  │DeviceMgr    │UUIDCreator  │VoiceUI      │     │
...
| **UUIDCreator** | UUID-based element targeting | ✅ Compiles | com.augmentalis.uuidcreator | None |
...
| **Element Targeting** | UUIDCreator | ✅ Active | ✅ Compiles | v1.0 | v2.0 |
