...
- IDEA-SOLO is a single-agent variant that doesn't require Zen MCP
...
**DEFAULT BEHAVIOR:**
IDEA-SOLO uses self-review and human approval only.
...
**REVIEW APPROACH:**
- Self-review at each checkpoint where IDEA would consult agents
...
## Overview
IDEA-SOLO is a single-agent variant of the IDEA protocol that emphasizes specification-driven development with iterative implementation and continuous self-review. It maintains the same structured approach but without multi-agent collaboration.
