<!--
filename: Protocol-VOS4-Commit.md
created: 2025-01-27 19:00:00 PST
author: VOS4 Development Team
purpose: VOS4-specific commit protocol - project-specific extensions to universal standards
last-modified: 2025-10-17 00:27:00 PDT
version: 2.0.0
changelog:
- 2025-10-17 00:27:00 PDT: v2.0.0 - Extracted universal content to master protocols, kept only VOS4-specific
- 2025-01-27 19:00:00 PST: Initial creation
-->

# VOS4-Specific Commit Protocol

## Purpose
This document contains VOS4-SPECIFIC commit standards. For universal commit standards, see the master protocol files.

## 🔗 Required Reading - Universal Standards (IDEACODE v5.0)
**MANDATORY: Read these universal protocols FIRST:**
- `/Volumes/M Drive/Coding/ideacode/protocols/Protocol-Changelog-Management.md` - Universal commit/changelog standards
