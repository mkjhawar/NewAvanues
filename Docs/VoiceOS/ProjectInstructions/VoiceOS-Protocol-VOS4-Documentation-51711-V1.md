<!--
filename: Protocol-VOS4-Documentation.md
created: 2025-01-27 18:45:00 PST
author: VOS4 Development Team
copyright: Copyright (C) Manoj Jhawar/Aman Jhawar, Intelligent Devices LLC
purpose: VOS4-specific documentation protocol - project-specific extensions to universal standards
last-modified: 2025-10-17 00:28:00 PDT
version: 2.0.0
-->

# VOS4-Specific Documentation Protocol

## Purpose
This document contains VOS4-SPECIFIC documentation standards. For universal documentation standards, see the master protocol files.

## 🔗 Required Reading - Universal Standards (IDEACODE v5.0)
**MANDATORY: Read these universal protocols FIRST:**
- `/Volumes/M Drive/Coding/ideacode/protocols/Protocol-Documentation.md` - Universal documentation standards
- `/Volumes/M Drive/Coding/ideacode/protocols/Protocol-File-Organization.md` - Universal file organization
- `/Volumes/M Drive/Coding/ideacode/protocols/Protocol-Document-Lifecycle.md` - Document lifecycle (living vs static)
...
## Changelog
<!-- Most recent first -->
- 2025-10-17 00:28:00 PDT: v2.0.0 - Extracted universal content to master protocols, kept only VOS4-specific
...
# VOS4-Specific Documentation Standards
...
**See Full Protocol:** `/Volumes/M Drive/Coding/vos4/Docs/ProjectInstructions/Protocol-VOS4-Pre-Implementation-QA.md`
