...
- `/Volumes/M Drive/Coding/Warp/vos4/Agent-Instructions/` (project level)
...
- **Project-specific:** `/Volumes/M Drive/Coding/Warp/vos4/Docs/ProjectInstructions/` (VOS4 only)
...
**VOS4 Files Moved:** 12 files to `/Volumes/M Drive/Coding/Warp/vos4/Docs/ProjectInstructions/`
...
**Files Archived:** 7 superseded protocol files to `/Volumes/M Drive/Coding/Warp/vos4/Docs/Archive/deprecated-protocols/`
...
- `/Volumes/M Drive/Coding/Warp/vos4/Agent-Instructions/` - ALL files preserved
...
- `/Volumes/M Drive/Coding/Warp/vos4/Docs/ProjectInstructions/` - VOS4-specific
- `/Volumes/M Drive/Coding/Warp/vos4/Docs/Active/` - Current work
- `/Volumes/M Drive/Coding/Warp/vos4/Docs/Archive/deprecated-protocols/` - Archived files

**Original (Preserved):**
- `/Volumes/M Drive/Coding/Warp/Agent-Instructions/` - Original general location
- `/Volumes/M Drive/Coding/Warp/vos4/Agent-Instructions/` - Original project location
