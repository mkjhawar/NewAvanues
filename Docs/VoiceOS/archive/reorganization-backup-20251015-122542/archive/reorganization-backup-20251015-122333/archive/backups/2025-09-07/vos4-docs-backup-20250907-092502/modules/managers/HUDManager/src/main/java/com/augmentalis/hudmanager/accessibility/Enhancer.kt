/**
 * Enhancer.kt
 * Path: /Volumes/M Drive/Coding/Warp/vos4/managers/HUDManager/src/main/java/com/augmentalis/hudmanager/accessibility/Enhancer.kt
 * 
 * Created: 2025-01-23
...
class Enhancer(
    ...
    private fun loadAccessibilityPreferences() {
        ...
        val _systemAccessibility = context.getSystemService(Context.ACCESSIBILITY_SERVICE)
