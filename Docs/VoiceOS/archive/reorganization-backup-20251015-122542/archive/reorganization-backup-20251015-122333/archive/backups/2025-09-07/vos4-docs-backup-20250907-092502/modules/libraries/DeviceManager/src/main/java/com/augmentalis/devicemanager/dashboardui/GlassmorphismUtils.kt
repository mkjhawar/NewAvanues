/**
 * GlassmorphismUtils.kt - Glassmorphism UI utilities for DeviceManager
 * 
 * Copyright (C) Manoj Jhawar/Aman Jhawar, Intelligent Devices LLC
 * Author: VOS4 Development Team
 * Created: 2025-01-02
 * 
 * Provides glassmorphism visual effects for device management UI
 */
...
/**
 * Glass morphism configuration for device cards
 */
data class GlassMorphismConfig(
    ...
    val tintColor: Color = Color(0xFF2196F3),
...
/**
 * Glass morphism modifier for device components
 */
