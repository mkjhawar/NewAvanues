...
dependencies {
    ...
    // Machine Learning for gaze detection
    ...
    implementation(project(":libraries:DeviceManager"))       // For IMU integration
    implementation(project(":libraries:UUIDManager"))         // For unique identifiers
    implementation(project(":managers:VoiceDataManager"))       // For data persistence
    implementation(project(":managers:LocalizationManager"))  // For localization support
    // implementation(project(":apps:SpeechRecognition"))        // For voice command data - TEMP: Has compilation errors
    // implementation(project(":CodeImport:VoiceAccessibility")) // For accessibility integration - TODO: fix path
