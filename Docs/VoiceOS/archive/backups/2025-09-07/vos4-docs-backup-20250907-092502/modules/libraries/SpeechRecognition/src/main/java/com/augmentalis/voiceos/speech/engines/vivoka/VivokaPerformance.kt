...
class VivokaPerformance(
    ...
    fun recordPipelineRecovery(success: Boolean) {
        ...
        if (!success) {
            // TODO: recordFailure method doesn't exist in PerformanceMonitor
    ...
    fun getVivokaMetrics(): Map<String, Any> {
        ...
        return mutableMapOf<String, Any>().apply {
            ...
            this["sessionDuration"] = baseMetrics.sessionDuration
            ...
            this["minLatency"] = baseMetrics.minLatency
            this["maxLatency"] = baseMetrics.maxLatency
            this["currentMemoryUsage"] = baseMetrics.currentMemoryUsage
            this["memoryTrend"] = baseMetrics.memoryTrend
            this["bottlenecks"] = baseMetrics.bottlenecks
    ...
    private fun startBackgroundMonitoring() {
        ...
        performanceLoggingJob = coroutineScope.launch {
            while (isActive) {
                ...
                try {
                    performanceMonitor.logDetailedReport()
    ...
    fun getPerformanceState(): PerformanceMonitor.PerformanceState {
        return performanceMonitor.performanceState.value
    }
