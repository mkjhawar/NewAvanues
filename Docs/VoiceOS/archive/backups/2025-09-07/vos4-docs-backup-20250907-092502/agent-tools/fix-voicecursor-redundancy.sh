...
# Base directories
OLD_DIR="/Volumes/M Drive/Coding/Warp/vos4/apps/VoiceCursor/src/main/java/com/augmentalis/voiceos/voicecursor"
NEW_DIR="/Volumes/M Drive/Coding/Warp/vos4/apps/VoiceCursor/src/main/java/com/augmentalis/voiceos/cursor"
...
find "/Volumes/M Drive/Coding/Warp/vos4" -name "*.kt" -type f -exec sed -i '' \
