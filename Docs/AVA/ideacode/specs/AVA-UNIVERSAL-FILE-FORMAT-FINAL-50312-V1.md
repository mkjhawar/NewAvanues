...
|-----------|----------------|---------|---------|
| `.aai` | AVA | Voice intent examples | **Ava AI** (AI Voice Assistant) |
...
#### VoiceOS LearnApp IPC Codes

VoiceOS uses additional IPC codes for learned app navigation data:
...
**Field Separators:**
- `:` (colon) - Primary field separator
- `+` (plus) - Multiple values in field (e.g., `click+longClick`)
- `,` (comma) - Sub-field separator (e.g., `100,200,300,250`)
...
### Week 1: AVA (.aai)
- Convert .aai v1.0 → Universal Format
...
### AVA Project
- Chapter XX: Universal File Format (.aai)
...
- Chapter XX: LearnApp IPC Codes (APP, STA, SCR, ELM, NAV)
- Chapter XX: AI Context Generation
...
- Understanding File Extensions (.aai, .vos, .avc, .awb, .ami, .amc)
- Cross-App Communication

### AVA Users
- Teaching New Voice Commands
- Understanding .aai Files
- VoiceOS Integration
