 ...
 *
 * @property avidsCreated Number of Avids successfully created
...
data class AvidCreationMetrics(
    ...
    fun getCreationRate(): Float {
        ...
        return (avidsCreated.toFloat() / elementsDetected) * 100f
    }
    ...
    fun toSummaryString(): String {
        return buildString {
            append("Avids: $avidsCreated/$elementsDetected")
    ...
    fun toReportString(): String {
        return buildString {
            ...
            appendLine("  Avids Created: $avidsCreated")
    ...
    companion object {
        ...
        fun combine(metricsList: List<AvidCreationMetrics>): AvidCreationMetrics {
            ...
            return AvidCreationMetrics(
                avidsCreated = metricsList.sumOf { it.avidsCreated },
...
class AvidCreationMetricsBuilder {
    ...
    fun setAvidsCreated(count: Int) = apply { this.avidsCreated = count }
    ...
    fun incrementAvidsCreated(delta: Int = 1) = apply { this.avidsCreated += delta }
