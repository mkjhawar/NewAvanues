...
class AVUExporterTest {
    ...
    fun export_ValidState_GeneratesCorrectHeader() {
        ...
        assertTrue(content.contains("# Avanues Universal Format v1.0"), "Should have format header")
        ...
        assertTrue(content.contains("schema: avu-1.0"), "Should have schema version")
        assertTrue(content.contains("version: 1.0.0"), "Should have format version")
