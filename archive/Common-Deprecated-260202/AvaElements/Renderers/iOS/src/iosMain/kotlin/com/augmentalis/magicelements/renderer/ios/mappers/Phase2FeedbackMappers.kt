...
fun mapAlertToSwiftUI(
    ...
    val colorHex = when (component.severity) {
    ...
    return SwiftUIView(
        ...
        modifiers = listOf(
            SwiftUIModifier.foregroundColor(ModifierConverter.convertColor(Color.hex(colorHex)))
        )
    )
}
...
fun mapToastToSwiftUI(
    ...
    return SwiftUIView(
        ...
        modifiers = listOf(
            SwiftUIModifier.background(ModifierConverter.convertColor(Color.hex("#000000"))),
            SwiftUIModifier.foregroundColor(ModifierConverter.convertColor(Color.hex("#FFFFFF"))),
            SwiftUIModifier.opacity(0.85f),
            SwiftUIModifier.cornerRadius(12f),
            SwiftUIModifier.padding(16f, 16f, 12f, 12f)
        )
    )
}
...
fun mapSnackbarToSwiftUI(
    ...
    return SwiftUIView(
        ...
        modifiers = listOf(
            SwiftUIModifier.background(ModifierConverter.convertColor(Color.hex("#1C1C1E"))),
            SwiftUIModifier.foregroundColor(ModifierConverter.convertColor(Color.hex("#FFFFFF"))),
...
fun mapModalToSwiftUI(
    ...
    return SwiftUIView(
        ...
        modifiers = listOf(
            SwiftUIModifier.background(ModifierConverter.convertColor(Color.hex("#FFFFFF"))),
            SwiftUIModifier.cornerRadius(12f)
        )
    )
}
...
fun mapDialogToSwiftUI(
    ...
    return SwiftUIView(
        ...
        modifiers = listOf(
            SwiftUIModifier.background(ModifierConverter.convertColor(Color.hex("#FFFFFF"))),
            SwiftUIModifier.cornerRadius(12f),
            SwiftUIModifier.padding(24f, 24f, 24f, 24f)
        )
    )
}
...
fun mapBannerToSwiftUI(
    ...
    val bgColor = when (component.severity) {
    ...
    val fgColor = when (component.severity) {
    ...
    return SwiftUIView(
        ...
        modifiers = listOf(
            SwiftUIModifier.background(ModifierConverter.convertColor(Color.hex(bgColor))),
            SwiftUIModifier.foregroundColor(ModifierConverter.convertColor(Color.hex(fgColor))),
            SwiftUIModifier.cornerRadius(8f),
...
// Temporary data classes - should be moved to commonMain
