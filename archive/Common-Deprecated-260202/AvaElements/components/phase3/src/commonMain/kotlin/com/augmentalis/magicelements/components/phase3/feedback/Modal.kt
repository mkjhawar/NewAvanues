...
data class Modal(override val type: String = "Modal", override val id: String? = null, val open: Boolean = false, val title: String? = null, @Transient val onClose: (() -> Unit)? = null, override val style: ComponentStyle? = null, @Transient override val modifiers: List<Modifier> = emptyList()) : Component { override fun render(renderer: Renderer) = renderer.render(this) }
