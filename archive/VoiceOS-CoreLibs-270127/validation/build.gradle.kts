/**
 * build.gradle.kts - VoiceOS Validation KMP Library
 *
...
android {
    namespace = "com.augmentalis.voiceos.validation"
    compileSdk = 34
...
publishing {
    publications {
        publications.withType<MavenPublication> {
            pom {
                name.set("VoiceOS Validation")
                description.set("Input validation and sanitization utilities for VoiceOS platform")
