...
open class UUIDCreator(
     ...
     */
    override suspend fun registerElement(element: UUIDElement): String {
     ...
     */
    override suspend fun unregisterElement(uuid: String): Boolean {
        return registry.unregister(uuid)
    }
