...
object ThemeManagerExample {
     ...
     */
    fun example11_CompleteIntegration() = runBlocking {
    ...
    fun example12_CustomThemeWithInheritance() = runBlocking {
        ...
        val customTheme = baseTheme.copy(
            ...
            colorScheme = baseTheme.colorScheme.copy(
                mode = com.augmentalis.avaelements.core.ColorScheme.ColorMode.Dark,
                primary = com.augmentalis.avaelements.core.Color.hex("#BB86FC"),
                background = com.augmentalis.avaelements.core.Color.hex("#121212")
            )
        )
