...
data class RadioButton(override val type: String = "RadioButton", override val id: String? = null, val selected: Boolean = false, val label: String? = null, val value: String, @Transient val onSelect: (() -> Unit)? = null, override val style: ComponentStyle? = null, @Transient override val modifiers: List<Modifier> = emptyList()) : Component { override fun render(renderer: Renderer) = renderer.render(this) }
