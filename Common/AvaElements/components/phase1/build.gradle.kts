...
group = "com.augmentalis.avaelements.components"
version = "2.0.0"
...
kotlin {
    ...
    // Windows target (experimental) - DISABLED until plugin system is complete
    // mingwX64()

    sourceSets {
        val commonMain by getting {
            dependencies {
                // Depend on MagicElements Core
        ...
        // DISABLED until plugin system is complete
        /*
...
android {
    namespace = "com.augmentalis.avaelements.components.phase1"
    compileSdk = 34
